...
| ID | 任務 | 狀態 | 前置 / 下一步 | 來源 |
|---|---|---|---|---|
| W23-B | **Assets By-OpCo inline edit**（前端逐格改 allocated/assigned → Save → `PATCH /license/ledger/:id`;OPCO_IT 只改自己行[W22 useMe gating];light+dark H6）—— W23-A carry | 候選（backend 已 live,可即開） | 前置:無（endpoint 已就緒）;kickoff W23-B plan | `W23-assets-manual-ledger/progress.md` Carry-overs |
