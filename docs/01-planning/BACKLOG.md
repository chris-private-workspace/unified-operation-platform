...
| W24 | **Phase 甲 inbound intake**（n8n onboarding request push → 平台 `POST /requests/intake` + m2m auth + 即時建本地 Request mirror;ADR-0008 D2/D4/D6） | 🔵 **進行中**（2026-07-15 kickoff;plan active;**D0 doc-sync 進行中**） | D0 doc-sync → D1 m2m auth 拍板 + intake 合約（待 n8n team 真 payload） | `W24-request-intake/` · `docs/adr/0008-*` |
