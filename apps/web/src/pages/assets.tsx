...
export function Assets() {
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      {/* Stats strip — Owned (tenant total) is intentionally absent: no tenant-
          owned endpoint yet (honest gap, see the note below). */}
      ...
      <p className="flex items-start gap-[7px] text-[11.5px] leading-[1.5] text-fg-subtle">
        ...
        <span>
          ...
          tenant-level owned / unallocated view lands once a tenant-owned
          endpoint is exposed.
        </span>
      </p>
    </div>
